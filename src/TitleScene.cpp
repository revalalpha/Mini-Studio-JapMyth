...
// START MENU
TitleScene::TitleScene(sf::RenderWindow* window, SceneManager* sceneManager, const float& framerate, const std::string& execPath)
...
{
    m_music.openFromFile(_m_textureCache.getAbsoluteFilepath("dungeonRising.mp3"));
    m_music.play();
    m_music.setVolume(50);
    m_music.setLoop(true);
}

void TitleScene::processInput(const sf::Event& event)
{
